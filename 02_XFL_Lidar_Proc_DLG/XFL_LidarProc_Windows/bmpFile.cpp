...
//
///////////////////////////////////////////////////////////////////////////////////
#include "NJUST_3D_Lidar64_Final_2016/Lidar64/NJUST_ALV_BYD_H/ALV_BYD.h"
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include <math.h>
...
bool Rmw_Write8BitImg2BmpFileMark254Green255Red(BYTE *pImg,int width,int height,const char * filename)
{   //BmpHeader记录的真实的宽度
	//当宽度不是4的倍数时自动添加成4的倍数,进行了4对齐的扩展.
	FILE * fp;
    BITMAPFILEHEADER FileHeader;
